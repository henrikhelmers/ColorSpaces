...
class ColorSpacesRGBTests: XCTestCase {
    ...
    func testRGBToXYZRed() {
        ...
        let xyz = rgb.toXYZ()
        XCTAssertEqual(xyz.x, 0.4124564, accuracy: 1e-6)
        XCTAssertEqual(xyz.y, 0.2126729, accuracy: 1e-6)
        XCTAssertEqual(xyz.z, 0.0193339, accuracy: 1e-6)
    ...
    func testRGBToXYZGreen() {
        ...
        let xyz = rgb.toXYZ()
        XCTAssertEqual(xyz.x, 0.3575761, accuracy: 1e-6)
        XCTAssertEqual(xyz.y, 0.7151522, accuracy: 1e-6)
        XCTAssertEqual(xyz.z, 0.1191920, accuracy: 1e-6)
        XCTAssertEqual(xyz.alpha, 1, accuracy: 1e-6)
    }
    ...
    func testRGBToXYZBlue() {
        ...
        let xyz = rgb.toXYZ()
        XCTAssertEqual(xyz.x, 0.1804375, accuracy: 1e-6)
        XCTAssertEqual(xyz.y, 0.0721750, accuracy: 1e-6)
        XCTAssertEqual(xyz.z, 0.9503041, accuracy: 1e-6)
        XCTAssertEqual(xyz.alpha, 1, accuracy: 1e-6)
    }
    ...
    func testRGBToLAB() {
        ...
        XCTAssertEqual(manual.a, direct.a, accuracy: 1e-6)
    ...
    func testRGBLerp() {
        ...
        XCTAssertEqual(half.r, 0.10, accuracy: 1e-8)
        XCTAssertEqual(half.g, 0.35, accuracy: 1e-8)
        XCTAssertEqual(half.b, 0.60, accuracy: 1e-8)
        XCTAssertEqual(half.alpha, 0.5, accuracy: 1e-8)

        XCTAssertEqual(quarter.r, 0.050, accuracy: 1e-8)
        XCTAssertEqual(quarter.g, 0.425, accuracy: 1e-8)
        XCTAssertEqual(quarter.b, 0.800, accuracy: 1e-8)
